...
Images that are not URLs must be uploaded to your HP photo album and urls are cleaned of tracking info.  Alternatly post the image in a reply then obtain the image url from the posted image.
